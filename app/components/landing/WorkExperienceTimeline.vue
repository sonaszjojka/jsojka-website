...
const roles = [
    ...
    },
    {
        ...
        summary: "Nationwide deposit-return system for Kaucja.pl — requirements modelled in UML, delivery run as Kanban.",
        stack: ["UML", "Enterprise Architect", "Jira", "Confluence", "GitLab"],
